...
void loop() {
  ...
  if (millis() - lastTime >= sampleTime){
    ...
    left_vel = 0.2*((_LeftEncoderTicks*6283.185307179586)/((millis() - lastTime)*ENC_COUNT_REV)) + 0.8*left_vel; // Calculamos las revoluciones por minuto
    
    //left_vel = (_LeftEncoderTicks*6283.185307179586)/((millis() - lastTime)*ENC_COUNT_REV);
